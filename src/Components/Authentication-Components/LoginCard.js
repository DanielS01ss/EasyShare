			...
			<div>
				...
				<div>
					...
					<div class="flex items-start">
                        ...
                        {/* <button type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-14 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 flex flex-row justify-evenly"><p>Login with Google </p><img className="w-6" src={GoogleLogo} alt="google logo"/></button> */}
