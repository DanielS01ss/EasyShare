...
export const Modal = ()=>{
    ...
    const [isFileValidExtension, setIsFileValidExtension] = useState(false);
    const [isFileValidSize, setIsFileValidSize] = useState(false);
            ...
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                {/* <div className='flex flex-row justify-center mt-10 pb-10'>
                    <div className='bg-blue-100 w-9/12 p-2 text-teal-800 border-blue-700 border-2 rounded'>
                        <p className='text-xl'>File info <FontAwesomeIcon icon={faCircleInfo} /> </p>
                        <p className='text-xl'>File size:</p>
